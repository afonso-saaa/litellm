...
async def login(request: Request):  # noqa: PLR0915
    ...
    from ldap_auth import ldap_login

    is_valid = ldap_login(username, password)
    ...
    if is_valid:
        ...
        litellm_dashboard_ui += "ui/" if litellm_dashboard_ui.endswith("/") else "/ui/"
    ...
    if _user_row is not None:
        ...
        user_email = getattr(_user_row, "user_email", username)
        _password = getattr(_user_row, "password", None)
